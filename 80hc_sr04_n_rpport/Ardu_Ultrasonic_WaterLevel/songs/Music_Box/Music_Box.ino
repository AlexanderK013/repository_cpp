...
const byte ROWS = 5;
const byte COLS = 3;
char keys[ROWS][COLS] = { { 'A', 'F', 'K' }, { 'B', 'G', 'L' },
		{ 'C', 'H', 'M' }, { 'D', 'I', 'Y' }, { 'E', 'J', 'Z' } };
// Connect keypad Rows to these Arduino pins.
byte rowPins[ROWS] = { 2, 3, 4, 5, 6 };

// Connect keypad Columns to these Arduino pins.
byte colPins[COLS] = { 7, 8, 9 };

// Create the Keypad
//Keypad kpd = Keypad( makeKeymap(keys), rowPins, colPins, ROWS, COLS );

// Setup a tone object to make noise
Tone tone1;

#define OCTAVE_OFFSET 0

int notes[] = { 0, NOTE_C4, NOTE_CS4, NOTE_D4, NOTE_DS4, NOTE_E4, NOTE_F4,
...
//			break;
		...
		case 'M':     //fire
			play_rtttl(
					"MissionImp:d=16,o=6,b=95:32d,32d#,32d,32d#,32d,32d#,32d,32d#,32d,32d,32d#,32e,32f,32f#,32g,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,a#,g,2d,32p,a#,g,2c#,32p,a#,g,2c,a#5,8c,2p,32p,a#5,g5,2f#,32p,a#5,g5,2f,32p,a#5,g5,2e,d#,8d");
//     play_rtttl("MASH:d=8,o=5,b=140:4a,4g,f#,g,p,f#,p,g,p,f#,p,2e.,p,f#,e,4f#,e,f#,p,e,p,4d.,p,f#,4e,d,e,p,d,p,e,p,d,p,2c#.,p,d,c#,4d,c#,d,p,e,p,4f#,p,a,p,4b,a,b,p,a,p,b,p,2a.,4p,a,b,a,4b,a,b,p,2a.,a,4f#,a,b,p,d6,p,4e.6,d6,b,p,a,p,2b");
//      play_rtttl("Bond:d=4,o=5,b=80:32p,16c#6,32d#6,32d#6,16d#6,8d#6,16c#6,16c#6,16c#6,16c#6,32e6,32e6,16e6,8e6,16d#6,16d#6,16d#6,16c#6,32d#6,32d#6,16d#6,8d#6,16c#6,16c#6,16c#6,16c#6,32e6,32e6,16e6,8e6,16d#6,16d6,16c#6,16c#7,c.7,16g#6,16f#6,g#.6");
			break;
		default:
			break;
		}
